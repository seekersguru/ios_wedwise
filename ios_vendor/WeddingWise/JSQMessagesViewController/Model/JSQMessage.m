                       ...
                       messageId:(NSString *)messageId
{
    ...
    self = [self initWithSenderId:senderId senderDisplayName:senderDisplayName date:date isMedia:NO messageId:messageId];
    if (self) {
        _text = [text copy];
    }
    return self;
                       ...
                       messageId:(NSString *)messageId
{
    ...
    self = [self initWithSenderId:senderId senderDisplayName:senderDisplayName date:date isMedia:YES messageId:messageId];
    if (self) {
        _media = media;
    }
    return self;
